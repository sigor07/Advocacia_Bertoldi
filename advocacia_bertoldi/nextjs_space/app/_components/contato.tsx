...
export function Contato() {
  ...
  return (
    <section id="contato" className="relative bg-secondary/40 py-20 md:py-28">
        ...
        <div className="mt-12 grid gap-8 lg:grid-cols-2">
          ...
          <FadeIn delay={0.1}>
            <form
              ...
              className="rounded-2xl bg-card p-6 shadow-[var(--shadow-md)] ring-1 ring-border/60 md:p-8"
            >
              <div className="grid gap-5">
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <Input id="name" value={form.name} onChange={update('name')} placeholder="Nome completo" className="pl-10" required />
                  </div>
                </div>
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <Input id="email" type="email" value={form.email} onChange={update('email')} placeholder="voce@email.com" className="pl-10" required />
                  </div>
                </div>
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <Input id="subject" value={form.subject} onChange={update('subject')} placeholder="Sobre o que deseja falar?" className="pl-10" required />
                  </div>
                </div>
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <Textarea
                      ...
                      className="min-h-[200px] pl-10 pt-3"
                      required
                    />
                  </div>
                </div>
                ...
                const inner = (
                  <>
                    ...
                    <span className="min-w-0">
                      ...
                      <span className="block truncate text-sm font-medium text-foreground" suppressHydrationWarning>{item.value}</span>
                    </span>
                  </>
                )
                const motionProps = {
                  ...
                  className:
                    'flex items-center gap-4 rounded-xl bg-card p-4 shadow-[var(--shadow-sm)] ring-1 ring-border/60 transition-all hover:shadow-[var(--shadow-md)] hover:ring-primary/30',
                }
                return href ? (
                  <motion.a
                    key={item.label}
